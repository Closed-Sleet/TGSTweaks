...
@Mod(TGStweaks.MODID)
public class TGStweaks
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "tgs_tweaks";
    ...
    /* Creates a creative tab with the id "examplemod:example_tab" for the example item, that is placed after the combat tab
     public static final RegistryObject<CreativeModeTab> Tweaks = CREATIVE_MODE_TABS.register("Tweaks", () -> CreativeModeTab.builder()
    ...
    public TGStweaks(FMLJavaModLoadingContext context)
    {
